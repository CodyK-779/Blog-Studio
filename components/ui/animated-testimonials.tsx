...
export const AnimatedTestimonials = ({
  ...
  useEffect(() => {
    // Generate random rotation values once on the client
  ...
  // Wait for client-only values to be ready
  if (rotationValues.length !== testimonials.length) return null;
      ...
      <div className="relative grid grid-cols-1 sm:gap-20 gap-12 md:grid-cols-2">
        ...
        <div className="flex flex-col justify-between py-4">
          ...
          >
            ...
            <motion.p className="mt-8 text-lg text-gray-500 dark:text-neutral-300 font-medium">
